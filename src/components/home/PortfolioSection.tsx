...
const projects = [
  ...
  },
  {
    ...
    image: "./public/adega-element.png",
  ...
  },
  {
    ...
    title: 'Triway Pro',
    category: 'Desenvolvimento',
    description: 'Landing page locação de ar-condicionado.',
    image: "./public/triway.png",
    technologies: ['React', 'JavaScript', 'CSS'],
    link: 'https://www.triwaypro.com.br/',
  },
  {
    id: 6,
    title: 'Fatia de Lei',
    category: 'Desenvolvimento',
    description: 'Landing page e e-commerce para confeitaria artesanal.',
    image: "./public/fatia-de-lei.png",
    technologies: ['React', 'JavaScript', 'CSS'],
    link: 'https://www.fatiadelei.com.br/',
  },
  {
    id: 7,
