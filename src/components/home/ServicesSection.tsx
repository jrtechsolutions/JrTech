...
const services = [
  {
    ...
    description: 'Planejamento, implementação e gestão completa da sua infraestrutura tecnológica.',
    features: ['Servidores físicos e virtuais', 'Gestão de datacenter', 'Backup e recuperação', 'Alta disponibilidade'],
    color: 'blue',
  },
  {
    icon: Shield,
    ...
    description: 'Soluções robustas de cibersegurança para proteger seus dados e operações.',
    features: ['Firewall e antivírus', 'Gestão de vulnerabilidades', 'Monitoramento 24/7', 'Resposta a incidentes'],
    color: 'green',
  },
  {
    icon: Cloud,
    ...
    description: 'Leve sua empresa para a nuvem com segurança, escalabilidade e economia.',
    features: ['AWS, Azure e Google Cloud', 'Migração planejada', 'Otimização de custos', 'Ambientes híbridos'],
    color: 'cyan',
  },
  {
    icon: Headphones,
    ...
    description: 'Equipe dedicada para resolver problemas e manter sua operação funcionando.',
    features: ['Help desk remoto', 'Suporte presencial', 'SLA garantido', 'Atendimento 24/7'],
    color: 'purple',
  },
  {
    icon: Network,
    ...
    description: 'Redes estruturadas de alta performance para conectar toda sua empresa.',
    features: ['Cabeamento estruturado', 'Wi-Fi corporativo', 'VPN segura', 'SD-WAN'],
    color: 'orange',
  },
  {
    icon: Database,
    ...
    description: 'Administração profissional de bancos de dados e inteligência de negócios.',
    features: ['Administração de BD', 'Business Intelligence', 'ETL e integração', 'Performance tuning'],
    color: 'pink',
  },
];
